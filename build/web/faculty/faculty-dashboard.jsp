  ...
  <body>
    ...
    <div id="pcoded" class="pcoded">
        ...
        <div class="page-body">
            <div class="row">
                <div class="col-12">
    <h2 class="text-center mb-4" style="background-color: ">Welcome to Faculty Dashboard</h2>
</div>
                ...
                <div class="col-md-6 col-lg-6 col-xl-4">
                    <div class="card widget-card-1">
                        <div class="card-block-small">
                            <i class="icofont icofont-hospital bg-c-blue card1-icon"></i>
                            <span class="text-c-blue f-w-600">Total Students</span>
                            <h4><%=students%></h4>
                            <div>
                            </div>
                        </div>
                ...
                <div class="col-md-6 col-lg-6 col-xl-4">
                    <div class="card widget-card-1">
                        <div class="card-block-small">
                            <i class="icofont icofont-stethoscope-alt bg-c-pink card1-icon"></i>
                            <span class="text-c-pink f-w-600">Total Classes</span>
                            <h4><%=classes%></h4>
                            <div>
                            </div>
                        </div>
                ...
                <div class="col-md-6 col-lg-6 col-xl-4">
                    <div class="card widget-card-1">
                        <div class="card-block-small">
                            <i class="icofont icofont-close-circled bg-c-green card1-icon"></i>
                            <span class="text-c-green f-w-600">Total Branches</span>
                            <h4><%=branches%></h4>
                            <div>
                            </div>
                        </div>
                ...
                <div class="col-md-6 col-lg-6 col-xl-4">
                    <div class="card widget-card-1">
                        <div class="card-block-small">
                            ...
                            <span class="text-c-yellow f-w-600">Classes Active</span>
                            <h4><%=active%></h4>
                            <div>
                            </div>
                        </div>
