    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="student-login.jsp" class="nav-item nav-link">Student Login</a>
                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item text-center pt-3">
                        <div class="p-4">
                            ...
                            <p>Instructors are very skilled and experienced.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item text-center pt-3">
                        <div class="p-4">
                            ...
                            <p>Classes are scheduled and informed to students.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item text-center pt-3">
                        <div class="p-4">
                            ...
                            <h5 class="mb-3">Online Attendance</h5>
                            <p>Attendance is marked by students based on Location and Time.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="service-item text-center pt-3">
                        <div class="p-4">
                            ...
                            <h5 class="mb-3">Subject Assistance</h5>
                            <p>Assistance is provided for every subject by Instructors.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <h1 class="mb-4">Welcome to GLSAS</h1>
                    <p class="mb-4">Attendance is marked by students itself.</p>
                    <p class="mb-4">Marked attendance is verified by using their location and time when they marked the attendance.If the location of class and student matches then only attendannce is recorded.</p>
                    <div class="row gy-2 gx-4 mb-4">
                        ...
                        <div class="col-sm-6">
                            <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Subject Assistance</p>
                        </div>
                        <div class="col-sm-6">
                            <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Instructors Availability</p>
                        </div>
                        <div class="col-sm-6">
                            <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Easy Study</p>
                        </div>
                    </div>
