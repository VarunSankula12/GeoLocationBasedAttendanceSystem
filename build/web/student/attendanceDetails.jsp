...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <a href="attendanceDetails.jsp" class="nav-item nav-link active">My Attendance Details</a>
    ...
    <div class="container-fluid page-header mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container">
            <h1 class="display-3 mb-4 animated slideInDown">Attendance Details</h1>
            <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            <li class="breadcrumb-item"><a class="text-white" href="student-dashboard.jsp">Dashboard</a></li>
                            <li class="breadcrumb-item text-white active" aria-current="page">Attendance Details</li>
                        </ol>
                    </nav>
        </div>
    </div>
                ...
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-header py-3">
                            <h2 class="mb-0 text-center"><b>Attendance Details</b></h2>
                        </div>
    ...
    <%
            ...
            String q2="SELECT * FROM students WHERE rollnum='"+rollnum+"'";
            ResultSet rs2=userDao.Retrieve(q2);
            if(rs2.next()){
                branch=rs2.getString("branch");
            }
            String q1="SELECT * FROM classdetails WHERE branch='"+branch+"' OR branch='All'";
    ...
    %>                        
                             <tr>
                                    ...
                                    <%
                                        String query="SELECT * FROM attendance WHERE rollnum='"+rollnum+"' && classid='"+rs.getString("classid")+"'";
                                        ResultSet rs1=userDao.Retrieve(query);
                                        if(rs1.next()){
                                    %>
                                    <td><%=rs1.getString("attendancetime")%></td>
                                    <td>PRESENT</td>
                                    <%
                                        }else{    
                                    %>
