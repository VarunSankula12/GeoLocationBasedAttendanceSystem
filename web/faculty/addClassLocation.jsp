...
<script>
                ...
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-header py-3">
                            <h2 class="mb-0 text-center"><b>Add Class Location</b></h2>
                        </div>
    ...
    %>                        
                            <tbody>  
                                <tr>
                                    <td class="ellipsis"><%=rs.getString("facultyname")%></td>
                                    <td class="ellipsis"><%=rs.getString("start_time")%></td>
                                    <td class="ellipsis"><%=rs.getString("subject")%></td>
                                    <td class="ellipsis"><%=rs.getString("branch")%></td>
                                    <td class="ellipsis"><%=rs.getString("section")%></td>
                                    <td>
                                        <a href="locationDetails.jsp?id=<%=rs.getString("classid")%>" class="btn btn-success">Add Location</a>
                                    </td>
                                </tr>
                            </tbody>
    <%
