    ...
    %>                        
                            <tbody>  
                                <tr>
                                    ...
                                    <td><%=rs.getString("inchargeName")%></td>
                                    <td><%=rs.getString("date")%></td>
                                    <td><%=rs.getString("subject")%></td>
                                    <td><%=rs.getString("classtime")%></td>
                                    <td><%=rs.getString("attendancetime")%></td>
                                    <td>
                                        <a href="viewStudentAttendance.jsp?roll=<%=rs.getString("rollnum")%>" class="btn btn-primary">View</a>
                                    </td>
                                </tr>
                            </tbody>
    <%
