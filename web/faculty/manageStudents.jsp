                ...
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-header py-3">
                            <h2 class="mb-0 text-center"><b>Manage Students</b></h2>
                        </div>
...
%>                                  
                                <tr>
                                    ...
                                    <td>
                                        <a href="AcceptStudent.jsp?email=<%=rs.getString("email")%>" class="btn btn-success">Accept</a>
                                        <a href="RejectStudent.jsp?email=<%=rs.getString("email")%>" class="btn btn-danger">Reject</a>
                                    </td>
                                </tr>
  <%
      }
