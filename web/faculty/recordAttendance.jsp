                ...
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-header py-3">
                            <h2 class="mb-0 text-center"><b>Record Attendance</b></h2>
                        </div>
    ...
    %>                        
                            <tbody>  
                                <tr>
                                    ...
                                    <td>
                                        <a href="startAction.jsp?classid=<%=rs.getString("classid")%>" class="btn btn-primary">Start</a>
                                        <a href="endClass.jsp?classid=<%=rs.getString("classid")%>" class="btn btn-secondary">End</a>                                        
                                    </td>
                                    <td>
                                        <a href="locationDetails.jsp?id=<%=rs.getString("classid")%>" class="btn btn-success">Change Location</a>
                                        <a href="deleteClass.jsp?id=<%=rs.getString("classid")%>" class="btn btn-danger">Delete</a>
                                    </td>
                                </tr>
                            </tbody>
    <%
