...
<head>
    ...
    <script type="text/javascript">  
        ...
        if (block===""){ 
            Swal.fire('Block Cannot be empty');
          return false;  
        }
        if (floor===""){
            Swal.fire("Floor cannot be empty");           
            return false;
        }
        if(room===""){
            Swal.fire("Room Can't be empty");
            return false;
        }
        if (longitude===""){
           Swal.fire("Longitude cannot be blank");            
            return false;
        }
        if (latitude===""){
           Swal.fire("Latitude cannot be blank");            
            return false;
        } 
  ...
  <body>
    ...
    <div id="pcoded" class="pcoded">
        ...
        <h1 class="text-center">Add Class Location</h1>

        <form action="locationAction.jsp" id="myform" name="myform" onsubmit="return validateuser()" class="form-box mainForm px-4  mb-2 pt-5" style="margin-top:-40px" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="longitude" name="longitude" placeholder="78.50****">
            </div>

            <div class="form-group">
                <label for="latitude">Latitude:</label>
                <input type="text" class="form-control" id="latitude" name="latitude" placeholder="17.20****" >
            </div>
