...
<head>
    ...
    <script type="text/javascript">  
        ...
        var classIncharge=document.myform.classIncharge.value;
        ...
        if (classIncharge===""){ 
            Swal.fire('Incharge Name Cannot be empty');
          return false;  
        }
        if (subject===""){
        ...
        if(branch===""){
            Swal.fire("Branch Can't be empty");
            return false;
        }
        if (section===""){
        ...
        if (startTime===""){
           Swal.fire("Start Time cannot be blank");            
            return false;
        } 
        if (endTime===""){
            Swal.fire("End Time cannot be blank");            
            return false;
        }
  ...
  <body>
    ...
    <div id="pcoded" class="pcoded">
        ...
        <form action="addClassAction.jsp" id="myform" name="myform" onsubmit="return validateuser()" class="form-box mainForm px-4  mb-2 pt-5" style="margin-top:-40px" method="post">
            <div class="form-group">
                <label for="classIncharge">Class Incharge:</label>
                <input type="text" class="form-control" id="classIncharge" name="classIncharge" >
            </div>
