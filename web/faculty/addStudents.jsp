...
<head>
    ...
    <script type="text/javascript">  
        ...
        if (branch===""){ 
            Swal.fire('Branch Cannot be empty'); 
          return false;  
        }
        if (section===""){ 
            Swal.fire('SectionCannot be empty'); 
          return false;  
        }
        if(phone===""){
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card mb-4">
                        ...
                        <form class="form-container" action="addStudentsAction.jsp" method="post" enctype="multipart/form-data">
                <div class="card-header py-3">
                            <h2 class="mb-0 text-center"><b>Add Students</b></h2>
                        </div>
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="rollnum" name="rollnum" placeholder="Roll Number" required>
                        </div>
                    </div>
